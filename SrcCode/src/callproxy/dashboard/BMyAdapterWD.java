...
public class BMyAdapterWD extends ArrayAdapter<BData> {

	Context context;
	List<BData> data;

	public BMyAdapterWD(Context context, int textViewResourceId, List<BData> data) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (v == null) {
			v = (LinearLayout) LayoutInflater.from(getContext()).inflate(
					R.layout.listitemtemp, parent, false);
		}
